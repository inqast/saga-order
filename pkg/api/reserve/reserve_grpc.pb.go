...
type ReserveServiceClient interface {
	GetReservesByOrderId(ctx context.Context, in *ID, opts ...grpc.CallOption) (*GetReservesResponse, error)
}
...
func (c *reserveServiceClient) GetReservesByOrderId(ctx context.Context, in *ID, opts ...grpc.CallOption) (*GetReservesResponse, error) {
	out := new(GetReservesResponse)
	err := c.cc.Invoke(ctx, "/reserve.ReserveService/GetReservesByOrderId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReserveServiceServer interface {
	GetReservesByOrderId(context.Context, *ID) (*GetReservesResponse, error)
...
func (UnimplementedReserveServiceServer) GetReservesByOrderId(context.Context, *ID) (*GetReservesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReservesByOrderId not implemented")
}
...
func _ReserveService_GetReservesByOrderId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReserveServiceServer).GetReservesByOrderId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/reserve.ReserveService/GetReservesByOrderId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReserveServiceServer).GetReservesByOrderId(ctx, req.(*ID))
	}
...
var ReserveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetReservesByOrderId",
			Handler:    _ReserveService_GetReservesByOrderId_Handler,
		},
	},
