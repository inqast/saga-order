...
//go:generate minimock -i github.com/inqast/saga-order/internal/order/app.Producer -o ./producer_mock_test.go -n ProducerMock
...
// ProducerMock implements Producer
type ProducerMock struct {
	t minimock.Tester

	funcSendMessage          func(pp1 *sarama.ProducerMessage) (partition int32, offset int64, err error)
	inspectFuncSendMessage   func(pp1 *sarama.ProducerMessage)
	afterSendMessageCounter  uint64
	beforeSendMessageCounter uint64
	SendMessageMock          mProducerMockSendMessage
}

// NewProducerMock returns a mock for Producer
...
func (mmSendMessage *mProducerMockSendMessage) Expect(pp1 *sarama.ProducerMessage) *mProducerMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &ProducerMockSendMessageParams{pp1}
...
func (mmSendMessage *mProducerMockSendMessage) Inspect(f func(pp1 *sarama.ProducerMessage)) *mProducerMockSendMessage {
...
func (mmSendMessage *mProducerMockSendMessage) Set(f func(pp1 *sarama.ProducerMessage) (partition int32, offset int64, err error)) *ProducerMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mProducerMockSendMessage) When(pp1 *sarama.ProducerMessage) *ProducerMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ProducerMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &ProducerMockSendMessageExpectation{
		...
		params: &ProducerMockSendMessageParams{pp1},
	}
...
// SendMessage implements Producer
func (mmSendMessage *ProducerMock) SendMessage(pp1 *sarama.ProducerMessage) (partition int32, offset int64, err error) {
	mm_atomic.AddUint64(&mmSendMessage.beforeSendMessageCounter, 1)
	defer mm_atomic.AddUint64(&mmSendMessage.afterSendMessageCounter, 1)

	if mmSendMessage.inspectFuncSendMessage != nil {
		mmSendMessage.inspectFuncSendMessage(pp1)
	}

	mm_params := &ProducerMockSendMessageParams{pp1}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := ProducerMockSendMessageParams{pp1}
	...
	if mmSendMessage.funcSendMessage != nil {
		return mmSendMessage.funcSendMessage(pp1)
	}
	mmSendMessage.t.Fatalf("Unexpected call to ProducerMock.SendMessage. %v", pp1)
	return
}
